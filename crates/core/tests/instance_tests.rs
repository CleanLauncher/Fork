...
macro_rules! generate_instance_test {
    ($test_name:ident, $type_enum:expr, $type_str:expr, $name_prefix:expr, $version:expr, $key_str:expr) => {
        ...
        fn $test_name() {
            ...
            assert!(content.contains($version), "Missing version {} in {}", $version, instance_name);
...
// Generate 100+ tests!
// Vanilla versions
generate_instance_test!(test_vanilla_1_19_2, InstanceType::Vanilla, "Vanilla", "vanilla", "1.19.2", "Version");
generate_instance_test!(test_vanilla_1_18_2, InstanceType::Vanilla, "Vanilla", "vanilla", "1.18.2", "Version");
generate_instance_test!(test_vanilla_1_17_1, InstanceType::Vanilla, "Vanilla", "vanilla", "1.17.1", "Version");
generate_instance_test!(test_vanilla_1_16_5, InstanceType::Vanilla, "Vanilla", "vanilla", "1.16.5", "Version");
generate_instance_test!(test_vanilla_1_15_2, InstanceType::Vanilla, "Vanilla", "vanilla", "1.15.2", "Version");
generate_instance_test!(test_vanilla_1_14_4, InstanceType::Vanilla, "Vanilla", "vanilla", "1.14.4", "Version");
generate_instance_test!(test_vanilla_1_13_2, InstanceType::Vanilla, "Vanilla", "vanilla", "1.13.2", "Version");
generate_instance_test!(test_vanilla_1_12_2, InstanceType::Vanilla, "Vanilla", "vanilla", "1.12.2", "Version");
generate_instance_test!(test_vanilla_1_8_9, InstanceType::Vanilla, "Vanilla", "vanilla", "1.8.9", "Version");
generate_instance_test!(test_vanilla_1_7_10, InstanceType::Vanilla, "Vanilla", "vanilla", "1.7.10", "Version");
...
generate_instance_test!(test_forge_recommended, InstanceType::Forge, "Forge", "forge", "recommended", "Version");
...
// LiteLoader versions
generate_instance_test!(test_liteloader_1_12_2, InstanceType::LiteLoader, "LiteLoader", "liteloader", "1.12.2-00-SNAPSHOT", "Version");
generate_instance_test!(test_liteloader_1_8_9, InstanceType::LiteLoader, "LiteLoader", "liteloader", "1.8.9-00-SNAPSHOT", "Version");
...
generate_instance_test!(test_ftb_interactions, InstanceType::FTB, "FTB", "ftb", "FTB_Interactions", "Modpack");
generate_instance_test!(test_ftb_skyfactory_3, InstanceType::FTB, "FTB", "ftb", "SkyFactory3", "Modpack");
generate_instance_test!(test_ftb_infinity_evolved, InstanceType::FTB, "FTB", "ftb", "InfinityEvolved", "Modpack");
generate_instance_test!(test_ftb_stoneblock_2, InstanceType::FTB, "FTB", "ftb", "Stoneblock2", "Modpack");

// Tekkit Modpacks
generate_instance_test!(test_tekkit_classic, InstanceType::Tekkit, "Tekkit", "tekkit", "TekkitClassic", "Modpack");
generate_instance_test!(test_tekkit_legends, InstanceType::Tekkit, "Tekkit", "tekkit", "TekkitLegends", "Modpack");
...
// CurseForge Modpacks
generate_instance_test!(test_curse_rlcraft, InstanceType::CurseForge, "CurseForge", "curseforge", "RLCraft", "Modpack");
generate_instance_test!(test_curse_sevtech, InstanceType::CurseForge, "CurseForge", "curseforge", "SevTech_Ages", "Modpack");
generate_instance_test!(test_curse_all_the_mods_8, InstanceType::CurseForge, "CurseForge", "curseforge", "AllTheMods8", "Modpack");
generate_instance_test!(test_curse_pixelmon, InstanceType::CurseForge, "CurseForge", "curseforge", "Pixelmon", "Modpack");
generate_instance_test!(test_curse_valhelsia_3, InstanceType::CurseForge, "CurseForge", "curseforge", "Valhelsia3", "Modpack");

// Modrinth Modpacks
generate_instance_test!(test_modrinth_fabulously_optimized, InstanceType::Modrinth, "Modrinth", "modrinth", "Fabulously_Optimized", "Modpack");
generate_instance_test!(test_modrinth_sop, InstanceType::Modrinth, "Modrinth", "modrinth", "Simply_Optimized", "Modpack");
generate_instance_test!(test_modrinth_additive, InstanceType::Modrinth, "Modrinth", "modrinth", "Additive", "Modpack");
generate_instance_test!(test_modrinth_vulbo, InstanceType::Modrinth, "Modrinth", "modrinth", "Vulbo", "Modpack");

// ATLauncher Modpacks
generate_instance_test!(test_atl_yogscast, InstanceType::ATLauncher, "ATLauncher", "atl", "Yogscast_Complete", "Modpack");
generate_instance_test!(test_atl_skyfactory_4, InstanceType::ATLauncher, "ATLauncher", "atl", "SkyFactory4", "Modpack");
generate_instance_test!(test_atl_crundee_craft, InstanceType::ATLauncher, "ATLauncher", "atl", "CrundeeCraft", "Modpack");
